...
Num_iterations = 1; % Number of iterations to average over
...
for i = 1:30
    ...
    for j = 1:Num_iterations
        ...
        % Run GOA6 algorithm
        [Best_score_6, ~, ~] = GOA16(25, Max_iteration, lb, ub, dim, fobj);
        results_GOA6(j) = Best_score_6;

        % Run GOA2 algorithm
        [Best_score_2, ~, ~] = GOA2(25, Max_iteration, lb, ub, dim, fobj);
