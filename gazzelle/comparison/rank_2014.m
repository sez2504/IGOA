...
folder_path = 'Results_cec14';  % Create a folder named "p_value_results"
...
for i = a:b
    ...
    gwo_scores(:, i) = tmp_gwo_scores;
     ...
     [p_values_fho(i), h_values_fho(i), ~] = ranksum(fho_scores(:, i), mgoa_scores(:, i));
     [p_values_aoa(i), h_values_aoa(i), ~] = ranksum(aoa_scores(:, i), mgoa_scores(:, i));
 ...
 save(fullfile(folder_path, 'p_values_aoa.mat'), 'p_values_aoa');
 save(fullfile(folder_path, 'p_values_coa.mat'), 'p_values_coa');
 save(fullfile(folder_path, 'p_values_mgoa.mat'), 'p_values_mgoa');
...
save(fullfile(folder_path, 'h_values_scso.mat'), 'h_values_scso');
 ...
 save(fullfile(folder_path, 'h_values_aoa.mat'), 'h_values_aoa');
 save(fullfile(folder_path, 'h_values_coa.mat'), 'h_values_coa');
 save(fullfile(folder_path, 'h_values_mgoa.mat'), 'h_values_mgoa');
