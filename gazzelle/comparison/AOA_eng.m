function [ Scorebest,Xbest,Convergence_curve] = AOA_eng(Materials_no,Max_iter,lb,ub, dim,fobj,C3,C4,VioFactor)
% Initialization
C1=2;C2=6;
u=.9;l=.1;   %paramters in Eq. (12)
X=initialization(Materials_no,dim,ub,lb);%initial positions Eq. (4)
den=rand(Materials_no,dim); % Eq. (5)
vol=rand(Materials_no,dim);
acc=initialization(Materials_no,dim,ub,lb);% Eq. (6)
