...
Num_iterations = 2; % Number of iterations to average over
...
for i = 1:23
    ...
    for j = 1:Num_iterations
        ...
        % Run GOA6 algorithm
        [Best_score_6, Best_pos_6, Convergence_curve_6] = GOA7(SearchAgents_no, Max_iteration, lb, ub, dim, fobj);
        results_GOA6(j) = Best_score_6;

        % Run GOA2 algorithm
        [Best_score_2, Best_pos_2, Convergence_curve_2] = GOA2(SearchAgents_no, Max_iteration, lb, ub, dim, fobj);
