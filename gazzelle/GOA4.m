...
function [Top_gazelle_fit,Top_gazelle_pos,Convergence_curve]=GOA4(SearchAgents_no,Max_iter,lb,ub,dim,fobj)
...
while Iter<Max_iter
 ...
 par=2-2*(Iter/Max_iter);
    ...
    for i=1:dim
        ...
        randomwalk=sin(randomwalk);
        temp_matrix=Elite';
        temp_matrix(i,:)=Top_gazelle_pos(1,i)+randomwalk*par;
        Elite=temp_matrix';
    end
